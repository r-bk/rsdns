...
pub enum ProtocolStrategy {
    ...
    /// [`QType::ANY`](crate::protocol::QType::ANY).
    ...
    /// Use UDP for all queries including [`QType::ANY`](crate::protocol::QType::ANY).
    ///
    /// By default [`QType::ANY`](crate::protocol::QType::ANY) queries use TCP only.
