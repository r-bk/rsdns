...
pub enum ProtocolStrategy {
    ...
    /// [`QType::ANY`](crate::protocol::constants::QType::ANY).
    ...
    /// Use UDP for all queries including [`QType::ANY`](crate::protocol::constants::QType::ANY).
    ///
    /// By default [`QType::ANY`](crate::protocol::constants::QType::ANY) queries use TCP only.
